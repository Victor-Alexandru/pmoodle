"""
Django settings for pmoodle project.
...
SECRET_KEY = 'x@6h$68jj9knl_gspuia%6)jpn!j)ylopbz^cocpvlvh_u(^z('
...
WSGI_APPLICATION = 'pmoodle.wsgi.application'
